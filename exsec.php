	...
	<body>
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/">uniBuddy</a>
				</div>
			
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="exsec.html">Link</a></li>
						<li><a href="#">Link</a></li>
					</ul>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						<td>Electronic Lab</td>
						<td>T</td>
						<td>36/40</td>
						<td>Introdution to Database</td>
						<td><button type="button" class="btn btn-xs btn-success">Contact</button></td>
						<td><button type="button" class="btn btn-xs btn-primary">Report</button></td>
					</tr>
					<tr>
